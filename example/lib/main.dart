...
class homePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Password Generator app"),
      ),
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            const DrawerHeader(
              ...
              child: Text('Password generator app ' ,  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25 , color: Colors.white),),
            ),
            ListTile(
...
class _MyApp1State extends State<MyApp> {
  bool _isWithLetters = true;
  bool _isWithUppercase = false;
  bool _isWithNumbers = false;
  bool _isWithSpecial = false;
